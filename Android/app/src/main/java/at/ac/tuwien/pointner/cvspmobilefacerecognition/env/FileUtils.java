package at.ac.tuwien.pointner.cvspmobilefacerecognition.env;
...
public class FileUtils {
    ...
    public static final String ROOT =
            Environment.getExternalStorageDirectory().getAbsolutePath() + File.separator + "cvspmobilefacerecognition";
